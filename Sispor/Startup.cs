...
namespace Sispor
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var connection = @"data source=(local)\\SQLEXPRESS;initial catalog=SisporDatabase;user id=rsaadmin;password=rsa123;MultipleActiveResultSets=True;";
            services.AddDbContext<SisporDatabaseContext>(options => options.UseSqlServer(connection));
            //END EF CORE
